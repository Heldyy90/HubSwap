...
| 1.20.1 | Fabric | Java 17 | `HubSwap-1.20.1-fabric.jar` | [Скачать](https://github.com/Heldyy90/HubSwap/releases/tag/v.1.0.5) |
...
| 🆕 Последняя версия | **[`v.1.0.5`](https://github.com/Heldyy90/HubSwap/releases/tag/v.1.0.5)** |
| 📅 Дата последнего релиза | **2026-06-21** |

[➡️ Подробная статистика по всем релизам](./STATS.md)

_Автообновление: 2026-07-14 13:14 UTC_
<!-- HUBSWAP-STATS:END -->
