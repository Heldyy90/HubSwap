...
| Показатель | Значение |
|---|---:|
| 📥 Всего скачиваний файлов | **172** |
| 🧩 Скачиваний `.jar` модов | **149** |
| 🚀 Всего релизов | **3** |
| 📦 Всего файлов в релизах | **7** |
| 🆕 Последняя версия | **[`v.1.0.2`](https://github.com/Heldyy90/HubSwap/releases/tag/v.1.0.2)** |
| 📅 Дата последнего релиза | **2026-04-02** |
