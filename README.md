...
Поддерживаются режимы **Classic**, **Lite**, **Lite 1.20** и **Prime**, быстрые команды, хоткеи, кликабельные названия серверов в чате, статистика переходов и автоматическая настройка задержек.
...
| 🚀 Всего релизов | **1** |
| 📦 Всего файлов в релизах | **1** |
| 🆕 Последний опубликованный релиз | **[`v1.0.7`](https://github.com/HolyWorldWEB/HubSwap/releases/tag/v1.0.7)** |
| 📅 Дата последнего релиза | **2026-08-11** |

[➡️ Все релизы HubSwap](https://github.com/HolyWorldWEB/HubSwap/releases)
